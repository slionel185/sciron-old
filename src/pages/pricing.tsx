...
export default function pricing() {
    ...
    return (
        <div className='flex flex-col justify-start items-center pt-16 pb-4 lg:h-screen w-full gap-4'>
            <div className='flex flex-col gap-4 justify-center items-center max-w-lg xl:max-w-2xl'>
                <Image src={Logo} alt='Logo' height={128} width={128} className='-mt-12 -m-6' />
            ...
            <div className='flex h-full flex-col gap-8 lg:flex-row w-full justify-center items-center px-8 pb-4'>
                <div id='free' className='card w-full md:w-96 lg:h-full bg-base-300 shadow-xl'>
                    <div className='card-body'>
                        ...
                        <h1 className='text-4xl py-2 pb-3 italic text-center'>$0<span className='text-sm'>/mo</span></h1>
                ...
                <div id='pro' className='card w-full md:w-96 lg:h-full bg-base-300 shadow-xl'>
                    <div className='card-body'>
                        ...
                        <h1 className='text-4xl py-2 pb-3 italic text-center'>$4.99<span className='text-sm'>/mo</span></h1>
                        <ul className='px-4 flex flex-col gap-2'>
                            <li className='flex justify-start items-center gap-4'>
                                <BsCheck2Circle className='text-xl text-success' />
                                <h1>Twitch Bot Access</h1>
                ...
                <div id='Lifetime' className='card w-full md:w-96 lg:h-full bg-base-300 shadow-xl'>
                    <div className='card-body'>
                        ...
                        <h1 className='text-4xl py-2 pb-3 italic text-center'>$14.99<span className='text-sm'>/mo</span></h1>
                        <ul className='px-4 flex flex-col gap-2'>
                            <li className='flex justify-start items-center gap-4'>
                                <BsCheck2Circle className='text-xl text-success' />
                                <h1>Twitch Bot Access</h1>
